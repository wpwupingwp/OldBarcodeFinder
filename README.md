...
1. ..Output barcode sequence of given data... Till now, it could find out barcode
   ...
   number, which need more test and worktime.

2. ..Pick up single-copy barcode... A nice barcode should be single-copy among
   genome. Herein, BarcodeFinder could automaticly drop multicopy candidate
